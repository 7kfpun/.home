...
install_dev_tools () {
    ...
    sudo apt-get install -y build-essential python-dev libxml2-dev git-core python-software-properties subversion supervisor postgresql python-psycopg2 vim-nox python-setuptools
}

install_python_modules () {
    print 'Install python modules.'
    sudo easy_install -U setuptools
    for I in "pip virtualenv pylint"; do
