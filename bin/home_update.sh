...
install_dev_tools () {
    ...
    apt-get install -y build-essential libxml2-dev git-core git-buildpackage exuberant-ctags python-software-properties subversion screen cmatrix virtualbox-qt openjdk-7-jdk curl nfs-kernel-server mongodb-clients redis-tools
